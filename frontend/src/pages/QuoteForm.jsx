  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload = {
        ...
        parent_id: 'parent-' + formData.child_id.split('-')[1], // Derive from child ID
      ...
      if (formData.billing_mode === 'par_seance') {
        payload.session_price = parseFloat(formData.session_price) || null;
        payload.sessions_per_month = parseInt(formData.sessions_per_month) || null;
      } else {
        payload.hourly_rate = parseFloat(formData.hourly_rate) || null;
